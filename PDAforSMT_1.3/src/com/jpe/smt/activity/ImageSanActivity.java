...
import com.jpe.smt.imageScan.GroupAdapter;
import com.jpe.smt.imageScan.ImageBean;
...
public class ImageSanActivity extends Activity {
	// 父文件夹名 和子文件夹中图片的路径
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case SCAN_OK:
				...
				adapter = new GroupAdapter(ImageSanActivity.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(ImageSanActivity.this,
						ShowImageActivity.class);
				// data中包含了被选中的相框中的所有图片的路径
				mIntent.putStringArrayListExtra("data",
						(ArrayList<String>) childList);
				startActivity(mIntent);
				ImageSanActivity.this.finish();
	...
	private void getImages() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				ContentResolver mContentResolver = ImageSanActivity.this
						.getContentResolver();
