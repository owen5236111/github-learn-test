...
import com.jpe.smt.imageScan.MyImageView.OnMeasureListener;
import com.jpe.smt.imageScan.NativeImageLoader.NativeImageCallBack;
...
public class ChildAdapter extends BaseAdapter {
	 ...
	 * @return
	 */
	public Set<String> getSelectItemsPaths(List<Integer> clist) {
		Set<String> paths =  new HashSet<String>();
		// 遍历选中的列表中的位置 获取路径
		for (int i = 0; i < clist.size(); i++) {
			String path = list.get(clist.get(i));
			paths.add(path);
		}
		return paths;
	}
