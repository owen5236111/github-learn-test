package com.jpe.smt.imageCache.loader;
 ...
 * 图片加载器.
 * <P>
 * 图片的加载过程：1.从自身的图片缓存中取;2.如果取不到,则从网络中获取.
 * <P>
 * 同时,我们可以停止后台的图片获取线程.
 * 
 * @author oywf
...
public abstract class ImageWorker {
	...
	/** 正在加载时候的图片. SparseArray安卓中用来代替hashmap 的数据结构*/
	...
	public void loadImage(String url, ImageView imageView, int loadingImageId) {
		...
		if (bitmap != null) {
			...
			final AsyncDrawable asyncDrawable = new AsyncDrawable(
					mContext.getResources(), getLoadingImage(loadingImageId),
					task);
